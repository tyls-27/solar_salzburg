...
# create new bounding box as bottom of map is cut off
#bbox_new <- st_bbox(hranice) # current bounding box

#xrange <- bbox_new$xmax - bbox_new$xmin # range of x values
#yrange <- bbox_new$ymax - bbox_new$ymin

# plot map
tm_shape(flaeche_geeignet, bbox = st_bbox(gemeinden_ltw)) +
